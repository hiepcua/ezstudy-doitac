...
function getListData($array, $type=''){//$type=1 lấy đại lý cấp
    ...
    if($array->Num_rows()>0){
        ...
        <table class="table table-main">
            <thead>
            <tr>
                <th class="stt"><strong>STT</strong></th>
                <th><strong>Họ và tên</strong></th>
                <th class="text-center"><strong>Quyền</strong></th>
                <th><strong>Ngày tạo</strong></th>
                <th class="download"><strong>Thao tác</strong></th>
            </tr>
            </thead>
            <tbody>
        <?php
        $stt=0;
            ...
            <tr>
                ...
                <td >
                    <p class="td-text"><b><?php echo $r_mem['fullname'];?></b></p>
                    <ul class="list-inline">
                        <li>TK:<?php echo $username;?></li>
                        <li>Phone:<?php echo $r_mem['phone'];?></li>
                    </ul>
                   <!-- <ul class="list-inline">
                        <li>Tỉ lệ thưởng:</li>
                ...
                <td class="text-center"><?php echo $nhom;?></td>
                <td class="txt-cdate"><?php echo $jdate;?></td>
