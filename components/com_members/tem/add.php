...
if(isLogin()){
    ...
    if(isset($_POST['cmdsave'])){
        ...
        if($er_mess==''){
            ...
            $arr['cmt_date']= $_POST['txt_cmt_date']!="" ? strtotime($_POST['txt_cmt_date']):0;
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-9'>
                                <input type='date' class='form-control'  name='txtbirthday' id='txtbirthday' placeholder='Ngày sinh' value=''/>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-9'>
                                <div class='row'>
                                    <div class='col-sm-6'><input type='text' class='form-control' name='txt_cmt' id='txt_cmt' placeholder='CMTND' value='<?php if(isset($_POST['txt_cmt'])) echo $_POST['txt_cmt'];?>'/></div>
